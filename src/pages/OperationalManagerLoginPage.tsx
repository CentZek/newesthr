...
const OperationalManagerLoginPage: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // We're using the same HR Auth context but with a different redirect path
    ...
    <div className="min-h-screen bg-[#e6eaff] flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="mb-4 flex items-center justify-center w-16 h-16 rounded-full bg-blue-600">
          ...
          <p className="text-sm text-gray-600 text-center">
            Access leave management and employee operations
          </p>
        </div>
        ...
        <div className="mt-6 text-center">
          <button
            onClick={() => navigate('/')} 
            className="text-blue-600 hover:text-blue-800 flex items-center justify-center mx-auto mt-2"
          >
...
export default OperationalManagerLoginPage;