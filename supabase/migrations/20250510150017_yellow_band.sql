/*
  # Fix Night Shift Display and Duplicate Record Issues
  
  1. Changes:
    - Add unique constraint to prevent duplicate manual entries with same shift and date
    - Fix display values for night shifts to consistently show 21:00-06:00
    - Ensure working_week_start is properly set for night shifts
    - Add function and trigger to properly handle employee-submitted shifts
    
  2. Issue Resolution:
    - Prevents duplicate records in Recent Manual Records
    - Ensures night shift records from different days properly link together
*/
