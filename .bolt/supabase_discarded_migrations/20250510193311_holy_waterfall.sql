/*
  # Fix Manual and Employee-Submitted Records Display
  
  1. Changes:
    - Fix manual and employee-submitted records showing incorrectly in Approved Hours view
    - Ensure standard display times are consistently used for all shift types
    - Fix missing check-out times in the Approved Hours view
    
  2. Data Integrity:
    - Update existing records to use proper display values
    - Ensure check-in and check-out fields are properly paired
    - Fix working_week_start values to correctly group related records
*/
